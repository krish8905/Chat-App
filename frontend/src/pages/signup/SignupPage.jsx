...
export default function SignupPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMsg("🎉 Woohoo! Account created successfully.");
  ...
  return (
    <AuthCard
      ...
      footer={
        <p className={`text-center text-sm font-medium ${theme === "dark" ? "text-slate-400" : "text-slate-600"}`}>
          ...
          <Link className={`font-semibold hover:underline transition-colors ${theme === "dark" ? "text-indigo-400 hover:text-indigo-300" : "text-blue-600 hover:text-blue-700"}`} to="/login">
            Login
          </Link>
        </p>
      }
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <AuthInput
          label="Username"
          icon={<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>}
          type="text"
